...
earth, prefs = pycli.new_model("custom", num_lat_gridlines=80, 
                               num_lon_gridlines=80, init_atmos = {"CO2": 0.0001})
...
for i in range(5):
    ...
    # get current CO2 level and bump concentration each step
